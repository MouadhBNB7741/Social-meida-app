...
-- CreateIndex
CREATE INDEX "communityPost_UserEmail_index" ON "CommunityPost"("UserEmail");

-- CreateIndex
CREATE INDEX "communityPost_communityId_index" ON "CommunityPost"("communityId");

-- CreateIndex
CREATE INDEX "message_chatRoomId_index" ON "Messages"("chatRoomId");

-- CreateIndex
CREATE INDEX "message_UserEmail_index" ON "Messages"("UserEmail");
